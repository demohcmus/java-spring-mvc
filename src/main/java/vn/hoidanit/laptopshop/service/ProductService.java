...
public class ProductService {
    ...
    public Specification<Product> buildPriceSpecification(List<String> price){
        ...
        for (String p: price){
            ...
            // Set the appropriate min and max based on the price range sring
            switch(p){
                case "duoi-10-trieu":
                min=0;
                max=10000000;
    ...
    public void handleAddProductToCart(String email, long productId, HttpSession session, long quantity) {
        ...
        if (user != null) {
            // check user đã có Cart chưa? -> tạo mới
            ...
            if (producOptional.isPresent()) {
                ...
                // check sản phẩn đã có từng được thêm vào giỏ hàng trước đây chưa?
    ...
    public void deleteProductInCart(long cartDetailId, HttpSession session) {
    ...
    public void handlePlaceOrder(User user, HttpSession session,
        ...
        if (cart != null) {
            ...
            if (cartDetails != null) {
                ...
                // step 3: update sum of cart through session
                session.setAttribute("sum", 0);
